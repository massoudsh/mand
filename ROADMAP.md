...
هدف: عبور از «score» به «تصمیم» کامل — کانال، زمان، نوع و مقدار مشوق.

- مدل uplift چندگزینه‌ای (multi-treatment)
- بهینه‌سازی تخصیص با محدودیت بودجه
- موتور best-time-to-send
- Policy layer برای قوانین کسب‌وکار
- API تصمیم برای اتصال به CRM design partner

**خروجی:** موتوری با خروجی «اکشن مشخص»، نه فقط score.
